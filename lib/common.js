...
//    var paramsNames = getParamNames(classObject.init);
//    paramsNames.unshift('thisArg'); // modification paramsNames
//    var fn = makeFnWithArguments(paramsNames, function (thisArg) {
//        thisArg.init && thisArg.init.apply(thisArg,arguments);
//    });
